...
public class ImageAvatar extends JComponent {
    ...
    this.image = new ImageIcon(newImage.getImage().getScaledInstance(getWidth(), getHeight(), Image.SCALE_SMOOTH));
    repaint(); // Redraw the component after setting the new image
    }
