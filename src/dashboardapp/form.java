...
public class form extends javax.swing.JFrame {
    ...
    //String display="Select  P_id,Type,Category,Brand,quantity,sellprice from Product";
    /**
     ...
     public void lowStockMessage()
   {
       try {
           ...
           PreparedStatement pst = connection.prepareStatement("Select p_id,Quantity,low_stock from Product");
...
this.getContentPane().setBackground(new java.awt.Color(5, 10, 48));

// Set foreground color of all labels to white
jLabel2.setForeground(new java.awt.Color(255, 255, 255)); // Customer Details
jLabel3.setForeground(new java.awt.Color(255, 255, 255)); // Date
jLabel1.setForeground(new java.awt.Color(255, 255, 255)); // Time
jLabel4.setForeground(new java.awt.Color(255, 255, 255)); // Name
jLabel5.setForeground(new java.awt.Color(255, 255, 255)); // Contact no.
jLabel6.setForeground(new java.awt.Color(255, 255, 255)); // E-Mail
jLabel7.setForeground(new java.awt.Color(255, 255, 255)); // Address
jLabel8.setForeground(new java.awt.Color(255, 255, 255)); // Product Details
jLabel9.setForeground(new java.awt.Color(255, 255, 255)); // Product ID
jLabel10.setForeground(new java.awt.Color(255, 255, 255)); // Product Name
jLabel11.setForeground(new java.awt.Color(255, 255, 255)); // Category
jLabel13.setForeground(new java.awt.Color(255, 255, 255)); // Total Amount
jLabel14.setForeground(new java.awt.Color(255, 255, 255)); // Quantity
jLabel15.setForeground(new java.awt.Color(255, 255, 255)); // Price
jLabel16.setForeground(new java.awt.Color(255, 255, 255)); // Return Amount
jLabel17.setForeground(new java.awt.Color(255, 255, 255)); // Paid Amount
jLabel12.setForeground(new java.awt.Color(255, 255, 255)); // jLabel12
jLabel18.setForeground(new java.awt.Color(255, 255, 255)); // jLabel18
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
       ...
       String path = "C:\\Users\\ROCHE\\Desktop\\Bills";
...
//GEN-LAST:event_jButton4ActionPerformed
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {        
        ...
        Connection con = ConnectionProvider.getCon();
        try {
            java.util.Date today = new java.util.Date(); // Get current date and time
            java.sql.Date sqlDate = new java.sql.Date(today.getTime()); // Convert to java.sql.Date
            PreparedStatement pst = con.prepareStatement("insert into daily_sales(quantity_sold,sale_date,Product_id) values(?,?,?)");
            pst.setInt(1,qty);
        ...
        try{
       Connection connection = ConnectionProvider.getCon();
       PreparedStatement statement = connection.prepareStatement("UPDATE Product SET Quantity = Quantity - ? WHERE p_id = ?");
    ...
    Connection connection = ConnectionProvider.getCon();
    PreparedStatement statement = connection.prepareStatement("UPDATE sales SET Quantity = Quantity + ?, sale_date = ? WHERE p_id = ?");
    statement.setInt(1, qty);
    statement.setDate(2, sqlDate); // Set the java.sql.Date object
